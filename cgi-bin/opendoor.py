...
# Open door script
# $Id: opendoor.py,v 1.1 2014/06/18 16:29:22 bob Exp $
#
# Author : Bob Rathbone
# Site   : http://www.bobrathbone.com
#
# This script opens the garage door
#
...
write_html_header();
print "</p></p>"
print "<h1 align='center'>Opening garage door</h1>";
print "</p></p>"
...
write_html_footer();
os.system("/usr/bin/sudo /usr/lib/cgi-bin/ggpiod.py open")
time.sleep(3)
